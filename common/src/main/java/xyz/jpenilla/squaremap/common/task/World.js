...
class World {
    ...
    load(callback) {
        S.getJSON(
            ...
            (json) => {
                ...
                this.world_border_label = json.world_border_label || this.world_border_label || "World Border";
    ...
    markers(json) {
        ...
        for (const entry of json) {
            ...
            const layerName = entry.id === "chunky"
                ? (this.world_border_label || entry.name || "World Border")
                : entry.name;

            // setup the layer control
            if (entry.control === true) {
                S.layerControl.addOverlay(layerName, layer, entry.hide);
            }
